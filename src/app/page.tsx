...
export default function Home() {
  ...
  const handleToggleExpand = (getCurrentId: number) => {
    setSelected(getCurrentId === selected ? 0 : getCurrentId);
    setIsExpanded(!isExpanded);
  };

  const handleToggleFaq = (getCurrentId: number) => {
    setFaqSelected(getCurrentId === faqSelected ? 0 : getCurrentId);
  };
            ...
            >
              ...
              >
                ...
                <i className=' text-2xl'>
                  {isFaqExpanded ? <IoIosArrowUp /> : <IoIosArrowDown />}
                </i>
              </h2>
              {faqSelected === item.id ? (
